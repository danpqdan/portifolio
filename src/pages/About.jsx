      ...
      <div className="card-carousel about-card" ref={rootRef}>
        <div className="about-left">
          ...
          <div className="contact-list">
            ...
            <a href="mailto:seu.email@exemplo.com"><FiMail /> seu.email@exemplo.com</a>
            <a href="tel:+5511999999999"><FiPhone /> +55 11 99999-9999</a>
          </div>
        ...
        <div className="card-content about-right">
          ...
          <div className="card-actions">
            ...
            <button className="primary-btn">reiniciar projeto</button>
          </div>
        </div>
      </div >
    </div >
